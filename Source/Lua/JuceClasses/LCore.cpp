...
void LString::wrapForLua (lua_State *L)
{
    ...
    [
		class_<String>("String")
			...
			.def(constructor<StringRef>())
			.def(constructor<CharPointer_UTF8>())
			...
			.def("startsWith", (bool (String::*)(StringRef) const) &String::startsWith)
			.def("startsWithIgnoreCase", (bool (String::*)(StringRef) const) &String::startsWithIgnoreCase)
        ...
        class_<StringRef>("StringRef")
            ...
            .def(constructor<const String &>())
			.def(constructor<const std::string &>())
			.def("isEmpty", &StringRef::isEmpty)
			.def("isNotEmpty", &StringRef::isNotEmpty)
			.def("length", &StringRef::length)
        ,
		...
		class_<StringArray, bases<LStringArray> >("StringArray")
			...
			.def("addArray", (void (StringArray::*)(const StringArray &, int, int))&StringArray::addArray)
